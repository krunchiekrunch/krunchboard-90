...
keyboard.keymap = [
    ...
    [
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, kimport board
# import digitalio
from kmk.kmk_keyboard import KMKKeyboard
from kmk.scanners.keypad import MatrixScanner
from kmk.keys import KC
...
RSW = KC.TD(Fn, KC.MUTE)
LOCKTD = KC.TD(KC.NO, KC.MACRO(Press(KC.LGUI), Delay(100), Tap(KC.L), Release(KC.LGUI)))
kk = KC.TD(KC.NO, KC.MACRO("krunchiekrunch", Tap(KC.ENTER)))
RMB = KC.TD(KC.MACRO(Release(KC.MB_RMB)), KC.MACRO(Press(KC.MB_RMB)),)
